...
public abstract class Scalar extends Number implements Value, Curvable<Number>, Mixable<Number> {
...
//	@Override
	public Scalar mix(Number a, Number b, double r) {
...
//	@Override
	public Scalar cubic(Number a, Number da, Number dd, Number d, double r) {
