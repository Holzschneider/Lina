...
//		System.out.println( new ArrayMatrix(a).clone().concatenate( new ArrayMatrix(b).clone() ) );
//		System.out.println( new ArrayMatrix(a).clone().preConcatenate( new ArrayMatrix(b).clone() ) );
